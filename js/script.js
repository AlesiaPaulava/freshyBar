...
const init = async () => {
  ...
  const { resetForm: resetFormMakeYourOwn } = calculateMakeYourOwn(); //функция для расчета коктейля Составь сам, resetFormMakeYourOwn добавлено,т.к. название resetForm уже существует
